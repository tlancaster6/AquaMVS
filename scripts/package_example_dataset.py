...
def generate_config_yaml(num_frames: int, has_filtered: bool) -> str:
    ...
    """
    image_dir = "./images/filtered" if has_filtered else "./images/unfiltered"
...
def _write_to_staging_dir(
    ...
    # Write config
    config_content = generate_config_yaml(len(frame_indices), has_filtered)
