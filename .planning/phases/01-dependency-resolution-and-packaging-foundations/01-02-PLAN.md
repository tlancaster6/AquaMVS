...
@.planning/phases/01-dependency-resolution-and-packaging-foundations/01-01-SUMMARY.md — dependency strategy decisions (LightGlue, AquaCal, RoMa) that determine CI install steps
@pyproject.toml
</context>
...
5. Dependency installation steps match strategy chosen in Plan 01 (read from 01-01-SUMMARY.md)
